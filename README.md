...
Specifically, this was an HTML-formatted report which was run against the
...
get a feel for how this program works.
...
Contributing
------------
I'm very interested in compiling some payload sets for various popular
3rd-party frameworks. (For an example, look at `/payloads/wordpress.rb`,
which is Wordpress-specific.) If you have expertise in a popular
web framework (Joomla, Drupal, etc), and would like to contribute some
payload files, please let me know. I'd eagerly welcome the participation.
