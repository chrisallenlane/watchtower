...
jQuery(document).ready(function(){
    ...
    if(typeof(Storage) !== 'undefined'){
        ...
        data_store  = {
            ...
            //save: function(){ localStorage.<%= watchtower_storage %> = $('div#main').html(); },
            save: function(){ localStorage.testing = 'some stuff'; },
            //save: function(){
                    //console.log($('div#main').html());
                    //console.log($('div.signature_2eed1fe0db36d674643b5f84d2adf46e').html());
                //},
            load: function(){
                if(localStorage.<%= watchtower_storage %> != null){
                    $('div#main').html(localStorage.<%= watchtower_storage %>);
                }
                // hide the appropriate PoIs
                $('div.point_of_interest.poi_hidden div.poi_content').hide();
                $('div.point_of_interest.poi_hidden div.poi_content span.poi_mark_content a.poi_hide').text('Show');
            }
        }
        data_store.load();
    } else {
